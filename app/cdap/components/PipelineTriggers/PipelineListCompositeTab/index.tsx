    ...
    <PipelineListTabDiv>
      ...
      <PipelineListContainer>
        ...
        {pipelineList.length === 0 ? null : (
          <div data-testid="composite-triggers-pipelines-container">
              ...
              nextIconButtonProps={
                {
                  ...
                  'data-testid': 'composite-triggers-pipeline-pagination-next-btn',
                } as any
              }
              backIconButtonProps={
                {
                  'data-testid': 'composite-triggers-pipeline-pagination-back-btn',
                } as any
              }
              SelectProps={{
                native: true,
                inputProps: {
                  'data-testid': 'composite-triggers-pipeline-pagination-select',
                },
              }}
            />
          </div>
